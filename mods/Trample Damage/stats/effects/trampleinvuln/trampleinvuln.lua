...
--]]
  ...
  and not (world.type() == "unknown") then --disable on ship. (anywhere else use unknown?)
    ...
    world.spawnProjectile(self.trampleProjectile.two, vec2.add(mcontroller.position(),{ 1, 4}), entity.id(), {0,0}, true)
    world.spawnProjectile(self.trampleProjectile.two, vec2.add(mcontroller.position(),{-3, 3.3}), entity.id(), {0,0}, true)
    world.spawnProjectile(self.trampleProjectile.two, vec2.add(mcontroller.position(),{ 3, 3.3}), entity.id(), {0,0}, true)
--    world.spawnProjectile(self.trampleProjectile.four,vec2.add(mcontroller.position(),{ 0, 3}), entity.id(), {0,0}, true)
    world.spawnProjectile(self.trampleProjectile.two, vec2.add(mcontroller.position(),{-3, 2}), entity.id(), {0,0}, true)
    world.spawnProjectile(self.trampleProjectile.two, vec2.add(mcontroller.position(),{ 3, 2}), entity.id(), {0,0}, true)
    world.spawnProjectile(self.trampleProjectile.two, vec2.add(mcontroller.position(),{-3, 0}), entity.id(), {0,0}, true)
    world.spawnProjectile(self.trampleProjectile.two, vec2.add(mcontroller.position(),{ 3, 0}), entity.id(), {0,0}, true)
    world.spawnProjectile(self.trampleProjectile.two, vec2.add(mcontroller.position(),{-3,-2}), entity.id(), {0,0}, true)
    world.spawnProjectile(self.trampleProjectile.two, vec2.add(mcontroller.position(),{ 3,-2}), entity.id(), {0,0}, true)
    world.spawnProjectile(self.trampleProjectile.two, vec2.add(mcontroller.position(),{-3,-4}), entity.id(), {0,0}, true)
    world.spawnProjectile(self.trampleProjectile.two, vec2.add(mcontroller.position(),{ 3,-4}), entity.id(), {0,0}, true)
    world.spawnProjectile(self.trampleProjectile.four,vec2.add(mcontroller.position(),{ 0,-5}), entity.id(), {0,0}, true)
    world.spawnProjectile(self.trampleProjectile.two, vec2.add(mcontroller.position(),{-3,-6}), entity.id(), {0,0}, true)
    world.spawnProjectile(self.trampleProjectile.two, vec2.add(mcontroller.position(),{ 3,-6}), entity.id(), {0,0}, true)
    world.spawnProjectile(self.trampleProjectile.two, vec2.add(mcontroller.position(),{-3,-7.5}), entity.id(), {0,0}, true)
    world.spawnProjectile(self.trampleProjectile.two, vec2.add(mcontroller.position(),{ 3,-7.5}), entity.id(), {0,0}, true)
